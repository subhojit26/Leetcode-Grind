...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Array` · `Dynamic Programming` · `Backtracking` · `Bit Manipulation` · `Breadth-First Search` · `Bitmask` |

> **LeetCode:** [minimum-time-to-break-locks-i](https://leetcode.com/problems/minimum-time-to-break-locks-i/)
