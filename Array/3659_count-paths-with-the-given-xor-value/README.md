...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Array` · `Dynamic Programming` · `Bit Manipulation` · `Matrix` |

> **LeetCode:** [count-paths-with-the-given-xor-value](https://leetcode.com/problems/count-paths-with-the-given-xor-value/)
