...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Array` · `String` · `Depth-First Search` · `Breadth-First Search` · `Graph Theory` |

> **LeetCode:** [maximize-amount-after-two-days-of-conversions](https://leetcode.com/problems/maximize-amount-after-two-days-of-conversions/)
