...
| Difficulty | Topics |
|:----------:|:------:|
| Hard | `Array` · `Binary Search` · `Stack` · `Binary Indexed Tree` · `Segment Tree` · `Heap (Priority Queue)` · `Monotonic Stack` |

> **LeetCode:** [find-building-where-alice-and-bob-can-meet](https://leetcode.com/problems/find-building-where-alice-and-bob-can-meet/)
