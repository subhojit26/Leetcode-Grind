...
| Difficulty | Topics |
|:----------:|:------:|
| Easy | `Array` · `Greedy` · `Matrix` |

> **LeetCode:** [minimum-operations-to-make-columns-strictly-increasing](https://leetcode.com/problems/minimum-operations-to-make-columns-strictly-increasing/)
