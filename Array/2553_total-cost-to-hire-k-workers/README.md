...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Array` · `Two Pointers` · `Heap (Priority Queue)` · `Simulation` |

> **LeetCode:** [total-cost-to-hire-k-workers](https://leetcode.com/problems/total-cost-to-hire-k-workers/)
