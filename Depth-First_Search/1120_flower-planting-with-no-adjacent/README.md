...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Depth-First Search` · `Breadth-First Search` · `Graph Theory` |

> **LeetCode:** [flower-planting-with-no-adjacent](https://leetcode.com/problems/flower-planting-with-no-adjacent/)
