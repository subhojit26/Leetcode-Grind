...
| Difficulty | Topics |
|:----------:|:------:|
| Medium | `Hash Table` · `String` · `Binary Search` · `Sliding Window` · `Counting` |

> **LeetCode:** [find-longest-special-substring-that-occurs-thrice-ii](https://leetcode.com/problems/find-longest-special-substring-that-occurs-thrice-ii/)
